...
def build_fnt(fntpath, ttfpath, outpath):
...
def main():
    ...
    build_fnt(
        os.path.join(basedir, r"./afs01/MINTYOU16.FNT"), 
        os.path.join(basedir, r"default.ttf"), 
        os.path.join(basedir, r"MINTYOU16_rebuild.FNT"))
    extract_fnt(
        os.path.join(basedir, r"MINTYOU16_rebuild.FNT"), 
        os.path.join(basedir,  r"./"))
    pass

def debug():
    #extract_fnt(r"D:\MAKE\Reverse\BaranoKini_psp\intermediate\MINTYOU16.FNT", r"D:\MAKE\Reverse\BaranoKini_psp\intermediate")
    pass
